...
<script type="text/javascript">
	function login() {
		...
		$.post("userServlet?type=registerValidate", $('#login_form').serialize(), function(data) {
  ...
  <body>
  	<div id="login_window"  style="height:500px">
  		<h1>用户注册</h1>
			...
			<p>
				<input type="text" class="text" id="name" name="name" placeholder="昵称">
			</p>
			<p>
				<input type="password" class="text" id="password" name="password" placeholder="密码">
			</p>
			<p>
				<button type="button" id="login_button" onclick="login()">注册</button>
			</p>
		</form>
		<h2></h2>
	</div>
